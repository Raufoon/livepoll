...
function onmessage(event) {
  ...
  switch (event.data.action) {
    ...
    case 'ACTION_UPDATE_BASIC_INFO':
      getLivepollStore().dispatch(actionRequestUpdateBasicInfo(payload.data));
      break;
    ...
    case 'ACTION_REQUEST_ADD_ITEM':
      getLivepollStore().dispatch(actionRequestAddItem(payload.pollId, payload.data));
      break;
    ...
    case 'ACTION_GIVE_VOTE':
      getLivepollStore().dispatch(actionGiveVote(payload.pollId, payload.itemId, payload.lastVotedItemId));
      break;
